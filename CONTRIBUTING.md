...
When you actually want to update the behavior of any CDK project, you need to update the integration tests before sending a PR. To do this, run `ci/update-cdk-integ-tests.sh [CDK FOLDER NAME]` using Bash or `ci/Update-CdkIntegTests.ps1 [CDK FOLDER NAME]` using PowerShell.
